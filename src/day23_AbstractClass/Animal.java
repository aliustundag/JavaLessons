...
/*
	    ...
	    7) It is not mandatory for "abstract child class" to override "abstract methods" from
	       parent class.
	    8) If any "abstract method" is overridden by any parent class, it will not be mandatory
	       for child classes
